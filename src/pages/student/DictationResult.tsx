...
import { Trophy, ArrowLeft, CheckCircle2, Book, HeartHandshake, ArrowRight, XCircle, AlertCircle, Clock, Volume2, Play, Pause, RefreshCw, Award, Star, HelpCircle, Medal, TrendingUp, Users, ListFilter, BarChart2, AlertTriangle, Info, Crown, User } from 'lucide-react';
      ...
      try {
        ...
        try {
          ...
          const { data: statsData, error: statsError } = await supabase
            ...
            .maybeSingle(); // Thay đổi từ single() sang maybeSingle() để tránh lỗi khi không có dữ liệu
            
          if (statsError) {
            console.error('Lỗi khi đọc dữ liệu từ student_attempt_stats:', statsError);
            throw new Error('Không thể đọc dữ liệu thống kê bài làm');
          }
          
          // Kiểm tra dữ liệu null và sử dụng fallback
          if (!statsData) {
            console.warn('Không tìm thấy dữ liệu trong student_attempt_stats, sử dụng fallback');
          ...
          if (answerData.metadata) {
            ...
            audioPlayCount = metadataObj.audioPlayCount || 0;
              ...
              console.warn('Không tìm thấy dữ liệu trong student_attempt_stats hoặc metadata, sử dụng giá trị mặc định');
              timeTaken = 0;
              audioPlayCount = 0;
            }
          } else {
            // Dữ liệu tồn tại, sử dụng bình thường
          ...
          // Đảm bảo có giá trị mặc định nếu có lỗi
          timeTaken = 0;
          audioPlayCount = 0;
        }
                        ...
                        {scoreInfo.errors && scoreInfo.errors.length > 0 && (
                          <div className="mt-4">
                            <h3 className="font-medium text-gray-700 mb-2 flex items-center">
                              ...
                              Các câu trả lời chưa chính xác:
                            </h3>
